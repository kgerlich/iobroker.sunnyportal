...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new sunnyportal name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/sunnyportal.png')) {
        fs.renameSync(__dirname + '/admin/sunnyportal.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/sunnyportal.html')) {
        fs.renameSync(__dirname + '/widgets/sunnyportal.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/sunnyportal/js/sunnyportal.js')) {
        fs.renameSync(__dirname + '/widgets/sunnyportal/js/sunnyportal.js', __dirname + '/widgets/sunnyportal/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/sunnyportal')) {
        fs.renameSync(__dirname + '/widgets/sunnyportal',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /sunnyportal/g,
        ...
        {
            match: /sunnyportal/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'sunnyportal'
        },
        {
